...
var AFileAction = /** @class */ (function (_super) {
    __extends(AFileAction, _super);
    function AFileAction(inFile, hash, options, filters) {
        if (filters === void 0) { filters = []; }
        var _this = _super.call(this, options, utils_1.resolveNewFilename(inFile, hash, options), filters
            .map(function (filter) { return filter === AFileAction.generateFilenameReplaceFilter ?
    ...
    AFileAction.generateFilenameReplaceFilter = function (file, _outFile) {
    ...
    AFileAction.prototype.run = function (filters) {
